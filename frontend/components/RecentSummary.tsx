  ...
  return (
    <section className="flex min-h-[320px] flex-col rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <header className="border-b border-zinc-200 px-4 py-3 dark:border-zinc-800">
        ...
        <p className="mt-1 text-xs text-zinc-500">One-line recap of the last ~30 seconds</p>
      </header>
      <div className="flex flex-1 flex-col justify-center p-4">
        {summary ? (
          <p className="text-sm leading-snug text-zinc-800 dark:text-zinc-200">{summary}</p>
        ) : (
